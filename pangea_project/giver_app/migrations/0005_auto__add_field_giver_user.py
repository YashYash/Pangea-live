...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Giver.user'
        db.add_column(u'giver_app_giver', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='giver', unique=True, null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Giver.user'
        db.delete_column(u'giver_app_giver', 'user_id')
    ...
    models = {
        ...
        u'giver_app.giver': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'giver'", 'unique': 'True', 'null': 'True', 'to': u"orm['auth.User']"}),
