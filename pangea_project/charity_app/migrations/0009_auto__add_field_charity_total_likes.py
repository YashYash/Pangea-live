...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Charity.total_likes'
        db.add_column(u'charity_app_charity', 'total_likes',
                      self.gf('django.db.models.fields.IntegerField')(max_length=15, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Charity.total_likes'
        db.delete_column(u'charity_app_charity', 'total_likes')
    ...
    models = {
        ...
        u'charity_app.charity': {
            ...
            'total_likes': ('django.db.models.fields.IntegerField', [], {'max_length': '15', 'null': 'True'}),
