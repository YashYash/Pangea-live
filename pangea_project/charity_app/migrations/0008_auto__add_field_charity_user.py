...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Charity.user'
        db.add_column(u'charity_app_charity', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='charity', unique=True, null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Charity.user'
        db.delete_column(u'charity_app_charity', 'user_id')
    ...
    models = {
        ...
        u'charity_app.charity': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'charity'", 'unique': 'True', 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'charity_app.video': {
